    ...
    <aside id="default-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-[#132145]">
            <ul class="space-y-2 font-medium">
                ...
                <!-- <li>
                    <a href="?= BASEURL; ?>/Prestasi/show" class="flex items-center p-2 text-white rounded-lg hover:bg-[#3063C559]">
                ...
                <!-- <li>
                    <a href="?= BASEURL; ?>/Admin/administrasiData" class="flex items-center p-2 text-white rounded-lg hover:bg-[#3063C559]">
