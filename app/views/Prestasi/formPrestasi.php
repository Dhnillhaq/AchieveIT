  ...
  <aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-[#132145]">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="index.html" class="flex items-center p-2 mt-10 text-white rounded-lg hover:bg-[#3063C559]">
            <img src="../../../public/img/Home_fill (1).png" alt="logo" class="w-5 h-5" />
            <span class="flex-1 ms-3 whitespace-nowrap">Beranda</span>
          </a>
        </li>
        <li>
          <a href="formPrestasi.html" class="flex items-center p-2 text-[#FEC01A] rounded-lg bg-[#3063C559]">
            <img src="../../../public/img/File_dock_add_fill (1).png" alt="logo" class="w-5 h-5" />
  ...
  <section class="sm:ml-64 bg-blue-50">
    ...
    <section class="relative p-6">
      ...
      <div class="static mt-5 p-6 bg-white border-2 rounded-lg border-[#FEC01A] space-y-2">
        ...
        <!-- juara -->
        <label for="nama" class="block text-gray-700 font-medium pt-6">Juara <span class="text-red-600">*</span></label>
        <select class="border rounded-lg px-2 py-1 w-1/3 bg-white shadow-gray-400 shadow-sm">
          ...
          <table class="min-w-full table-auto ">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="py-2 px-4 border border-blue-950">
                  <select class="w-full border rounded px-2 py-1">
                    <option>Melakukan pembinaan kegiatan mahasiswa di bidang akademik (PA) dan kemahasiswaan (BEM,
