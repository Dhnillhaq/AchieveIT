	...
	<form action="<?= BASEURL; ?>/Prestasi/store " method="POST" enctype="multipart/form-data">
		...
		<section class="relative p-6">
			...
			<div class="static mt-5 p-6 bg-white border-2 rounded-lg border-[#FEC01A] space-y-2">
				...
				<select name="kategori" class="border rounded-lg px-2 py-1 w-full lg:w-1/3 bg-white shadow-gray-400 shadow-sm">
				...
				<label for="nama" class="block text-gray-700 font-medium pt-6">Tingkatan Kompetisi <span
						class="text-red-600">*</span></label>
				<select class="border rounded-lg px-2 py-1 w-full lg:w-1/3 bg-white shadow-gray-400 shadow-sm"
...
<div class="flex flex-col md:flex-row items-center">
    <label
        ...
        <div class="flex flex-col items-center justify-center py-10 md:py-6">
            ...
            <p class="mb-2 text-sm font-semibold text-center">
        ...
        <div class="flex flex-col items-start py-6 space-y-1">
            <div class="flex flex-row justify-center items-center space-x-2">
                <p class="bg-[#FEC01A8F] py-1 px-14 rounded-xl hover:bg-yellow-400 text-center">Pilih File</p>
        ...
        <input type="file" class="hidden" id="file-input-1" name="surat_tugas" required
            onchange="showFileName(this, 1)">
				...
				<div class="flex flex-col md:flex-row items-center">
					<label
						class="flex flex-col md:flex-row items-center justify-center w-full bg-white border rounded-lg shadow-gray-400 shadow-sm space-x-10">
						<div class="flex flex-col items-center justify-center py-10 md:py-6">
							<img src="../../../public/img/Upload cloud.png" alt="logo" class="w-8 h-auto">
							<p class="mb-2 text-sm font-semibold text-center">
								Seret & lepas atau telusuri
...
<section class="relative p-6">
    ...
    <div class="static mt-5 p-6 bg-white border-2 rounded-lg border-[#FEC01A] space-y-2">
        ...
        <!-- btn tambah -->
        <section class="flex justify-start p-4">
            ...
            <table class="min-w-full table-auto">
                <thead>
                    <tr>
                        ...
                        <th class="w-1/6 py-2 px-4 bg-white font-semibold text-left border border-blue-950">
                            Peran Pembimbing
                        </th>
                        <th class="w-1/12 py-2 px-4 bg-white font-semibold text-left border border-blue-950">
                            Hapus
