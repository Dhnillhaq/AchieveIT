...
<html lang="en">
  ...
  <body class="font-[poppins]">
    ...
    <section id="daftar-prestasi" class="bg-[#132145D4] flex items-center justify-center min-h-screen">
      <div class="">
        <div class="row-start-2 flex flex-col items-center text-center">
          <h2 class="text-center text-2xl font-bold text-[#132145] mb-4 bg-[#FEC01A] rounded-lg px-4 py-1 ">Daftar Mahasiswa JTI Berprestasi</h2>
          <p class="text-center text-white text-[16px]"><span class="font-bold">Achieve IT</span> menghadirkan daftar mahasiswa berprestasi dari Jurusan Teknologi Informasi yang tersusun <br>
          berdasarkan capaian dan poin prestasi mereka. Daftar ini memberikan apresiasi kepada mahasiswa dengan <br> pencapaian tertinggi, sekaligus menginspirasi rekan lainnya untuk terus aktif dan unggul di berbagai bidang <br>
          kompetisi.
          </p>
        </div>
