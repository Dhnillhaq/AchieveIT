		...
		<div class="bg-white p-4 rounded-lg shadow-lg border w-full sm:w-1/3">
			<div class="flex justify-start space-x-4 items-center">
				...
				<div class="flex-col">
					...
					<p class="font-bold text-base"><?= $data['statistik']['total_prestasi'] ?></p>
				</div>
			</div>
		</div>
		...
		<div class="bg-white p-4 rounded-lg shadow-lg border w-full sm:w-1/3">
			<div class="flex justify-start space-x-4 items-center">
				...
				<div class="flex-col">
					...
					<p class="font-bold text-base"><?= $data['statistik']['total_poin'] ?></p>
				</div>
			</div>
		</div>
		...
		<div class="bg-white p-4 rounded-lg shadow-lg border w-full sm:w-1/3">
			<div class="flex justify-start space-x-4 items-center">
				...
				<div class="flex-col">
					...
					<p class="font-bold text-base"><?= $data['statistik']['peringkat_mapres'] ?></p>
				</div>
			</div>
		</div>
	</section>
