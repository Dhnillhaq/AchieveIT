    ...
    >
      <div class="h-full px-3 py-4 overflow-y-auto bg-[#132145]">
        <ul class="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              <img
                src="../../../../public/img/File_dock_search_fill.png"
                alt="logo"
                class="w-5 h-5"
              />
          ...
          <li>
            ...
            >
              <img
                src="../../../../public/img/Layers_fill.png"
                alt="logo"
                class="w-5 h-5"
              />
              <span class="flex-1 ms-3 whitespace-nowrap"
                >Administrasi Data</span
              >
            </a>
          </li>
          <li>
     ...
     <section class="sm:ml-64 bg-blue-50 min-h-screen">
      ...
      <section class="flex justify-end items-center p-8 space-x-3">
        ...
        <img
          src="../../../../public/img/Logo_archhieveIT.png"
          alt="logo"
          class="w-8 h-auto"
        />
      </section>
      ...
      <section class="relative p-6">
        ...
        <!-- Tingkat -->
          <label for="nama" class="block text-gray-700 font-medium pt-6"
            >Tingkat Kompetisi<span class="text-red-600">*</span></label
          >
          <input
            type="text"
          ...
          <!-- Tingkat -->
          <label for="nama" class="block text-gray-700 font-medium pt-6"
            >Poin<span class="text-red-600">*</span></label
          >
          <input
            type="text"
            placeholder="5"
