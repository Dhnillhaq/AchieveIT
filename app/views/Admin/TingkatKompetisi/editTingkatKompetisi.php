...
<head>
  ...
  <title>Edit Tingkat Kompetisi</title>
...
<body class="font-poppins">
  ...
  <section class="sm:ml-64 bg-blue-50 min-h-screen">
    ...
    <section class="flex-col justify-start pl-6">
      <p class="font-bold text-3xl">Edit Tingkat Kompetisi</p>
    </section>
    ...
    <section class="relative p-6">
      ...
      <div class="static mt-5 p-6 bg-white border-2 rounded-lg border-[#FEC01A] space-y-2">
        ...
        <input type="text" placeholder="Internasional"
          class="placeholder-black border rounded-lg px-2 py-1 w-1/3 bg-white shadow-gray-400 shadow-sm" />
        <!-- Tingkat -->
        <label for="nama" class="block text-gray-700 font-medium pt-6">Poin<span class="text-red-600">*</span></label>
