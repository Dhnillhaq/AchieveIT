<section class="sm:ml-64 bg-blue-50 min-h-screen">
	...
	<form action="<?= BASEURL; ?>/TingkatKompetisi/update" method="POST">
		<!-- Edit Tingkat -->
		...
		<section class="flex space-x-4 justify-start pl-4 pb-6">
			...
			<div class="justify-center p-2">
				<a href="<?= BASEURL; ?>/TingkatKompetisi/delete/<?= $data['id_tingkat_kompetisi'] ?>">
		...
		<input type="hidden" name="id_tingkat_kompetisi" value="<?= $data['id_tingkat_kompetisi'] ?>">
	</form>
</section>