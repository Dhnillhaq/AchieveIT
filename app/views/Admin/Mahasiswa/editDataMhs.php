...
<body class="font-poppins">
  ...
  <section class="sm:ml-64 bg-blue-50 min-h-screen">
    ...
    <section class="flex justify-end pr-6">
      <a href="#">
        <button class="flex items-center font-semibold space-x-2 py-2 px-6 text-white bg-[#132145] rounded-lg w-auto">
    ...
    <section class="relative p-6">
      ...
      <div class="static mt-5 p-6 bg-white border-2 rounded-lg border-[#FEC01A] space-y-2">
        ...
        <!-- NIM -->
        <label for="nama" class="block text-gray-700 font-medium pt-6">NIM <span class="text-red-600">*</span></label>
        <input type="text" placeholder=""
          class="placeholder-black border rounded-lg px-2 py-1 w-1/3 bg-white shadow-gray-400 shadow-sm" />

        <!-- Nama -->
        <label for="nama" class="block text-gray-700 font-medium pt-6">Nama<span class="text-red-600">*</span></label>
        <input type="text" placeholder=""
          class="placeholder-black border rounded-lg px-2 py-1 w-1/3 bg-white shadow-gray-400 shadow-sm" />
        ...
        <!-- Agama -->
        <label for="nama" class="block text-gray-700 font-medium pt-6">Agama<span class="text-red-600">*</span></label>
        <input type="text" placeholder=""
          class="placeholder-black border rounded-lg px-2 py-1 w-1/3 bg-white shadow-gray-400 shadow-sm" />
        ...
        <!-- Email -->
        <label for="nama" class="block text-gray-700 font-medium pt-6">Email<span class="text-red-600">*</span></label>
