    ...
    <section class="sm:ml-64 bg-blue-50 min-h-screen">
          ...
          <table class="min-w-full bg-white text-center">
            <thead>
              <tr>
                ...
                <th
                  class="py-2 px-4 w-1/4 bg-blue-950 text-white font-semibold border border-blue-950"
                >
                  Aksi
                </th>
              </tr>
      ...
      <tr>
        ...
        <td class="py-2 px-4 border border-blue-950">
          <button
            class="bg-[#132145] py-2 px-2 rounded-md mr-2"
          >
            <img src="../../../public/img/Edit_fill.png" alt="logo" class="">
          </button>
          <button
            class="bg-[#FF3B30] py-2 px-2 rounded-md"
          >
