                    ...
                    if (count($dataMahasiswa['id_mahasiswa']) === count($dataMahasiswa['id_peran'])) {
                        ...
                        for ($i = 0; $i < count($dataMahasiswa['id_mahasiswa']); $i++) {
                            ...
                            if (!$insertedPeranMahasiswa) {
                                throw new Exception("Gagal menambahkan data mahasiswa - prestasi");
                            }
                        }
                    } else {
                        throw new Exception("Data mahasiswa dan peran tidak sesuai");
                    }
                    ...
                    if (count($dataDosen['id_dosen']) === count($dataDosen['id_peran'])) {
                        ...
                        for ($i = 0; $i < count($dataDosen['id_dosen']); $i++) {
                            ...
                            if (!$insertedPeranDosen) {
                                throw new Exception("Gagal menambahkan data dosen - prestasi");
                            }
                        }
                    } else {
                        throw new Exception("Data dosen dan peran tidak sesuai");
                    }
                } else {
                    throw new Exception("Gagal menambahkan data prestasi");
                }
            }
